...
// contribution to energy and virial
	...
	if(instant_print==1){
		ofstream InstantEpot, InstantPres;
		InstantEpot.open("instant_epot.dat",ios::app);
		InstantPres.open("instant_pres.dat",ios::app);
		InstantEpot<<walker[iv]/(double)npart+vtail<<endl;
		InstantPres <<rho*temp+(walker[iw]+ptail*(double)npart)/vol<<endl;
		InstantEpot.close();
		InstantPres.close();
	}
